...
class SignupContainer extends StatelessWidget {
  ...
  const SignupContainer({Key? key, required this.child, required this.step})
      : super(key: key);
                  ...
                  children: [
                    ...
                    CircleAvatar(
                      ...
                      child: Text(
                        ...
                        style: kLargeHeavy.copyWith(
                          color:
                              step == 1 ? Colors.white : Styles.kDisabledButton,
                        ),
                      ),
                    ),
                    ...
                    CircleAvatar(
                      ...
                      child: Text(
                        ...
                        style: kLargeHeavy.copyWith(
                          color:
                              step == 2 ? Colors.white : Styles.kDisabledButton,
                        ),
                      ),
                    ),
                  ],
