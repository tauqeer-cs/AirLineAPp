                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      "Logout",
                      style:
                          kMediumRegular.copyWith(color: Styles.kPrimaryColor),
                    ),
                  ],
                ),
              ),
              ...
              child: Align(
                ...
                child: Row(
                  children: [
                    Text(
                      "Welcome back, ",
                      style: kHugeRegular.copyWith(color: Styles.kPrimaryColor),
                    ),
                    Text(
                      "${user?.firstName}",
                  ...
                  Padding(
                    ...
                    child: Align(
                      ...
                      child: Text(
                        ...
                        style:
                            kLargeRegular.copyWith(color: Styles.kSubTextColor),
                      ),
                    ),
                  ),
                  const SizedBox(
...
//w 150 h 100  w 370  w 370 / 2.462    370/3.7
