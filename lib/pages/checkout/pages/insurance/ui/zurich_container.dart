    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          kVerticalSpacerMini,
          RowBulletNumbering(title: "Enhance protection for your trip with Covid-19 coverage"),
          RowBulletNumbering(title: "Medical Expenses up to RM xxx"),
          RowBulletNumbering(title: "Trip Cancellation up to RM xxx"),
          kVerticalSpacerSmall,
          Center(
            child: Text(
              "View all benefits",
              style: kMediumHeavy.copyWith(color: Styles.kZurichColor, decoration: TextDecoration.underline),
            ),
          ),
        ],
      ),
