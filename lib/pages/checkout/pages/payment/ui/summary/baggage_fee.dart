...
class BaggageFeePayment extends StatefulWidget {
  ...
  const BaggageFeePayment({Key? key, required this.isDeparture, this.isSports = false}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        kVerticalSpacer,
        PriceRow(
          child1: Text(widget.isSports ? 'Sports Equipment' : "Baggage", style: k18Heavy),
        ...
        BaggageFeeDetailPayment(isDeparture: widget.isDeparture,isSports: widget.isSports,),
      ],
    );
  }
